...
print("--------MENU DE CALIFIACIONES-------")
 
n1 = int(input("Ingrese la primera calificación: "))

n2 = int(input("Ingrese la segunda calificación: "))

n3 = int(input("Ingrese la tercera calificación: "))
while True:
    print("\nMenú:")
